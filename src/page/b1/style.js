...
import Contopright from '../../images/con_topright.gif';
import Contopleft from '../../images/con_topleft.gif';
...
export const Title = styled.title`
    background: url(${Contopright}) no-repeat right top;
`;
export const Titlep = styled.p`
    background: url(${Contopleft}) no-repeat left top;
        text-align: left;
